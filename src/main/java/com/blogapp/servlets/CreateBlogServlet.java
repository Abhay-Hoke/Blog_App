...
//			
//			
//			String sql = "update blogs set title =?, content=?, image=?, updated_at=now() where id=? and created_by=?";
//			
//			ps = conn.prepareStatement(sql);
//			
//			ps.setString(1, title);
...
//			if (updatedRows > 0) {
//                response.sendRedirect("admin-dashboard.jsp?message=Blog post updated successfully");
//            } else {
//                response.sendRedirect("edit-blog.jsp?error=Blog post not found or you are not the creator");
//            }
//			
//			
//			
